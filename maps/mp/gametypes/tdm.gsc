	...
	if(isPlayer(attacker))
	{
		...
		else
		{
			...
			else
			{
				...
				// 123123231
				// maybe add some global event-system?
				mod\gametype::checkScoreLimit();
				attacker std\stats::add("xp", 10);
				attacker std\stats::add("money", 100);
			}
		}
...
spawnPlayer()
{
	mod\gametype::spawnPlayer(); // 123123231
}
